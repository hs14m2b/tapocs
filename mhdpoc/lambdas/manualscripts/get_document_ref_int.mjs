...
let drId = "X26-66dcc41d-1c26-4393-8d28-bfcecf4111a2";//"X26-c5ff4e4b-3c56-4ade-a95f-03f72a8d756a";//"1e404af3-077f-4bee-b7a6-a9be97e1ce01";
...
async function getDocRef (drId, access_token)
  {
    ...
    let options = {
      ...
      port: 443,
      method: 'GET',
      path: "/record-locator/consumer/FHIR/R4/DocumentReference/" + drId,
