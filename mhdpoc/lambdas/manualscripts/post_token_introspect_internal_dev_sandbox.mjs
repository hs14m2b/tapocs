...
const OAuthAPIKey = "lgA3WQ9NAVAySK3XQuQ4UCVn0z2SAAcx";
const environment = "internal-dev-sandbox";
...
async function sendToken (drId, access_token)
  {
    ...
    // request option
    let options = {
      host: environment + ".api.service.nhs.uk",
      port: 443,
      method: 'POST',
  ...
  async function getAccessToken(){
    ...
    environment + ".api.service.nhs.uk", "/oauth2/token");
    //console.log(blah);
    let blah2 = await getOAuth2AccessToken(blah, environment + ".api.service.nhs.uk", "/oauth2/token");
    console.log(blah2);
