      ...
      <body>
        ...
        <nav className="nhsuk-breadcrumb" aria-label="Breadcrumb">
          <div className="nhsuk-width-container">
            <ol className="nhsuk-breadcrumb__list">
              <li className="nhsuk-breadcrumb__item"><Link href="/" className="nhsuk-breadcrumb__link">Home</Link></li>
            </ol>
            <p className="nhsuk-breadcrumb__back"><Link className="nhsuk-breadcrumb__backlink" href="/">Back to Home</Link></p>
          </div>
        </nav>
        <div className="nhsuk-width-container ">
        ...
        <footer role="contentinfo">
          <div className="nhsuk-form-group">
            <label className="nhsuk-label" htmlFor="globaldebugarea">
              Global Debug Info
            </label>
            <textarea v-model="globaldebugtext" className="nhsuk-textarea" id="globaldebugarea" name="globaldebugarea" rows="5" tabIndex="-1"></textarea>
          </div>
          <div className="nhsuk-footer" id="nhsuk-footer">
            <div className="nhsuk-width-container">
              <h2 className="nhsuk-u-visually-hidden">Support links</h2>
              <ul className="nhsuk-footer__list">
                <li className="nhsuk-footer__list-item"><router-link className="nhsuk-footer__list-item-link" to="/">Home</router-link></li>
                <li className="nhsuk-footer__list-item"><router-link className="nhsuk-footer__list-item-link" to="/page2.html">Example page</router-link></li>
              </ul>
