...
function Home(props) {
  ...
  function checkData(propsandslot) {
    ...
    let appointmentb64=encodeURIComponent(propsandslot.props.appointmentb64)
    let appointmentId=propsandslot.props.appointmentId
    let barsidentifier=propsandslot.props.barsidentifier
    let barsserviceid=propsandslot.props.barsserviceid
    router.push("/rescheduleappointment?barsidentifier=" + barsidentifier + 
      "&barsserviceid=" + barsserviceid + 
      "&appointmentId=" + appointmentId + 
      "&appointmentb64=" + appointmentb64 +
      "&slotb64=" + slotb64);
  }
  ...
  return (
    <>
      ...
      <h2 className="nhsuk-heading-l">
        This page invokes the BaRS API to retrieve slots for a given service
      </h2>
      ...
      <Spinner message="Rescheduling Appointment..."></Spinner>
