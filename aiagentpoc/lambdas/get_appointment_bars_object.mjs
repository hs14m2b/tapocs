...
const getAppointment = async (appointmentid, identity_token, barsserviceid, odscode, APIENVIRONMENT, APIKEYSECRET, APIKNAMEPARAM) =>
{
  let XRequestID = uuidv4();
  let url = HTTPS + APIENVIRONMENT + ".api.service.nhs.uk" + "/booking-and-referral/FHIR/R4/Appointment/" + appointmentid;
...
export class get_appointment_bars{
  constructor(){
