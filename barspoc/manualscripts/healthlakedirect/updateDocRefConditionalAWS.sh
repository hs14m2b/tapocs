...
curl -X PUT "${HEALTHLAKEENDPOINT}DocumentReference?_id=033f9fcd-f74d-48ba-b9e9-84ee919af77b&custodian%3Aidentifier=https%3A%2F%2Ffhir.nhs.uk%2FId%2Fods-organization-code%7CxxxY05868" \
