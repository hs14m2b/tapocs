...
export const deleteResource = async (id, versionId, resourceType, headersJson, org, APIENVIRONMENT, APIKEYSECRET, APIKNAMEPARAM) =>
  {
...
export const deleteResourceWithRetry = async (maxDuration, id, versionId, resourceType, headersJson, org, APIENVIRONMENT, APIKEYSECRET, APIKNAMEPARAM) =>
{
  ...
  while (true){
    try {
      deleteResult = await deleteResource(id, versionId, resourceType, headersJson, org, APIENVIRONMENT, APIKEYSECRET, APIKNAMEPARAM);
      break;
    } catch (error) {
      console.log("caught error deleting resource in pdm - waiting a bit and trying again");
