...
export const postBundle = async (bundleJson,  headersJson, APIENVIRONMENT, APIKEYSECRET, APIKNAMEPARAM) =>
  {
    let url = HTTPS + APIENVIRONMENT + ".api.service.nhs.uk" + "/patient-data-manager/FHIR/R4";
    let XRequestID = getParameterCaseInsensitive(headersJson, "X-Request-ID");
