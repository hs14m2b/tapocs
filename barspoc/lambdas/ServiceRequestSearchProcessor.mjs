...
async function searchFhirServer(event, healthlakeSearchHelper, APIKEYSECRET, APIENVIRONMENT, APIKNAMEPARAM){
  ...
  try {
    ...
    let healthlakeresponse = await healthlakeSearchHelper.searchResourceWithRetry(maxDuration,event.queryStringParameters, "ServiceRequest", "Y05868", APIENVIRONMENT, APIKEYSECRET, APIKNAMEPARAM);
