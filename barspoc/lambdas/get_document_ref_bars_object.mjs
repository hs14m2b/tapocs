...
const getDocRef = async (documentReferenceId, odscode, APIENVIRONMENT, APIKEYSECRET, APIKNAMEPARAM) =>
{
  let XRequestID = uuidv4();
  let url = HTTPS + APIENVIRONMENT + ".api.service.nhs.uk" + "/booking-and-referral/FHIR/R4/DocumentReference/" + documentReferenceId;
...
export class get_document_ref_bars{
  constructor(){
