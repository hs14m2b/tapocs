...
const findDocRef = async (nhsnumber, odscode, APIENVIRONMENT, APIKEYSECRET, APIKNAMEPARAM) =>
{
  ...
  let url = HTTPS + APIENVIRONMENT + ".api.service.nhs.uk" + "/booking-and-referral/FHIR/R4/DocumentReference?" + subjectIdentifier;
...
export class find_document_ref_bars{
  constructor(){
