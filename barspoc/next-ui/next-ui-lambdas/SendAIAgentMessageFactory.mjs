import { handler as processor } from './SendAIAgentMessageProcessor.mjs';
...
export const handler = async (event) => {
  console.log(JSON.stringify(event));
    try {
        ...
        return await processor(event, snsCommonFunctionObjectInstance, bedrockAgentClient, InvokeAgentCommand, jwt, uuidv4, getParameterCaseInsensitive, APIENVIRONMENT, APIKEYSECRET, APIKNAMEPARAM, AIAGENTMESSAGETOPIC);
    } catch (error) {
