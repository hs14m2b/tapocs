...
const findTasks = async (nhsnumber, odscode, identity_token, APIENVIRONMENT, APIKEYSECRET, APIKNAMEPARAM) =>
{
  let XRequestID = uuidv4();
  let subjectIdentifier = new URLSearchParams({
    "patient:identifier" : "https://fhir.nhs.uk/Id/nhs-number|" + nhsnumber}).toString();
  let url = HTTPS + APIENVIRONMENT + ".api.service.nhs.uk" + "/patient-data-manager/FHIR/R4/Task?" + subjectIdentifier;
